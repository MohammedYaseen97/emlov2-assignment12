...
git_user = os.environ.get('GIT_USER', "Mohammed Yaseen")
git_email = os.environ.get('GIT_EMAIL', "47.yaseen@gmail.com")

ml_root = Path("/opt/ml/processing")

dataset_zip = ml_root / "input" / "intel-image-classification.zip"
